...
// Apply scroll reveal to project cards and other elements
document.addEventListener('DOMContentLoaded', function() {
    const revealElements = document.querySelectorAll('.project-card, .contact-item, .skill-item');
...
// Initialize code animation when about section is in view
...
document.querySelectorAll('.social-link').forEach(link => {
    link.addEventListener('mouseenter', function() {
        this.style.transform = 'translateY(-2px) scale(1.15) rotate(5deg)';
    });
...
// GitHub link special effects
document.querySelectorAll('.github-link, .inline-link').forEach(link => {
    link.addEventListener('mouseenter', function() {
